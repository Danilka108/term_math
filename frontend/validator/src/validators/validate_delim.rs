...
impl Validator {
    ...
    fn validate_to_presence_close_delim(&self) -> Result<(), Notification> {
    ...
    fn validate_next_token(&self, curr_token: &Token) -> Result<(), Notification> {
        if let Some(
            TokenKind::Eof
    ...
    fn validate_prev_token(&self, curr_token: &Token) -> Result<(), Notification> {
        if let None | Some(
            TokenKind::Ident(_)
    ...
    fn validate_close_delim(&mut self) -> Result<(), Notification> {
    ...
    fn validate_open_delim(&mut self) -> Result<(), Notification> {
        let (curr_token, curr_delim_kind) = match self.token_stream.curr() {
            Some(token) => match token.kind() {
    ...
    fn validate_delim_stack(&self) -> Result<(), Notification> {
    ...
    pub(crate) fn validate_delim(&mut self) -> Result<(), Notification> {
